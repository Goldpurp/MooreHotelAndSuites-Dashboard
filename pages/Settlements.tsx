...
const Settlements: React.FC = () => {
  ...
  const pendingSettlements = useMemo(() => {
    return (bookings || []).filter(
      (b) =>
        (b.paymentMethod === "DirectTransfer" ||
          b.paymentMethod === "Bank Transfer") &&
        (b.paymentStatus === PaymentStatus.AWAITING_VERIFICATION ||
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-[11px] font-bold uppercase tracking-widest mt-1">
            Manual bank transfer verification queue
          </p>
        </div>
              ...
              {filteredSettlements.length === 0 ? (
                <tr>
                  <td colSpan={5} className="py-40 text-center opacity-20">
                    ...
                    />
                    <p className="text-[14px] font-black uppercase tracking-[0.4em] text-slate-500 italic">
                ...
                filteredSettlements.map((log) => (
                  ...
                  >
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-[9px] text-slate-600 font-black uppercase mt-0.5 tracking-widest">
                    ...
                    <td className="px-8 py-6">
                      <div>
                        <p className="text-[15px] font-black text-slate-200 uppercase tracking-tight group-hover:text-blue-400 transition-colors italic">
                          {log.guestFirstName} {log.guestLastName}
                        </p>
                        <p className="text-[9px] text-slate-600 font-black uppercase tracking-dash mt-0.5">
                          Ref: {log.bookingCode}
                        </p>
                      </div>
                    </td>
                    ...
                    <td className="px-8 py-6 text-right">
                      <p className="text-[16px] font-black text-white italic">
        ...
        <div className="px-8 py-5 bg-slate-950/60 border-t border-white/5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <p className="text-[9px] text-slate-600 font-black uppercase tracking-[0.3em] italic">
              Moore Hotels Finance Protocol • Payment Verification Sequence
            </p>
          </div>
          <p className="text-[9px] text-slate-800 font-bold italic uppercase tracking-widest">
            Enterprise Ledger v8.7 Gold
          </p>
        </div>
      </div>
            ...
            <div className="p-8 space-y-6">
              <div className="p-5 bg-white/5 rounded-2xl border border-white/5 space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[13px] font-black text-white italic uppercase">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[13px] font-black text-white italic uppercase">
                    {selectedBooking?.guestFirstName}{" "}
                    {selectedBooking?.guestLastName}
                  </span>
                </div>
                <div className="flex justify-between items-center pt-4 border-t border-white/5">
                  ...
                  <span className="text-[18px] font-black text-emerald-400 tracking-tighter italic">
              ...
              <div className="flex flex-col gap-2">
                <p className="text-[10px] text-slate-400 font-bold uppercase tracking-tight leading-relaxed text-center italic">
                  Authorize this transfer as physically verified? This action
                  will update the global property ledger and mark the folio as
                  PAID.
                </p>
              </div>
      ...
      <div className="p-6 bg-blue-600/5 border border-blue-500/20 rounded-2xl flex items-start gap-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-[10px] text-slate-500 leading-relaxed font-bold uppercase tracking-tight">
            Direct Bank Transfers must only be confirmed after physical
            verification of the receipt or bank statement entry. Confirming a
            settlement will move the Folio to{" "}
            <span className="text-emerald-400">PAID</span> status and update the
            global property ledger.
          </p>
        </div>
      </div>
    </div>
