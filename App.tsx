...
const AppContent: React.FC = () => {
  const { isAuthenticated, isInitialLoading, isSidebarCollapsed, activeTab, refreshData } = useHotel();
    ...
    return (
      <div className="h-screen bg-slate-950 flex flex-col items-center justify-center gap-8 animate-in fade-in duration-700">
        ...
        <div className="text-center space-y-3">
           <h2 className="text-white font-black uppercase tracking-[0.5em] italic text-sm drop-shadow-2xl">Moore Systems</h2>
           <div className="flex flex-col items-center gap-1">
              <p className="text-slate-600 text-[9px] font-black uppercase tracking-[0.3em] animate-pulse">Synchronizing Security Tokens...</p>
    ...
    return (
      <Suspense fallback={
        <div className="h-screen bg-slate-950 flex items-center justify-center">
           <div className="text-slate-600 font-black uppercase tracking-[0.5em] italic text-xs animate-pulse">Moore Systems Initializing...</div>
        </div>
      }>
        <Auth />
      </Suspense>
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'operation_log': return <OperationLog />;
          ...
          <div className="max-w-7xl mx-auto w-full pb-32">
            <Suspense fallback={
              <div className="flex flex-col items-center justify-center h-[60vh] gap-6">
                ...
                <p className="text-[11px] font-black text-slate-600 uppercase tracking-[0.3em] italic animate-pulse">Initializing Interface Layer...</p>
              </div>
            }>
              {renderContent()}
            </Suspense>
